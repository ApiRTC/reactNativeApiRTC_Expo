...
### Background Effects (Blur & Background Image)

Our application supports background blur and background image replacement on Android, and background blur via the iOS Portrait Effect on iOS.

Here is [the documentation](Docs/add_background_effects.md) to help you add these features to your application.
